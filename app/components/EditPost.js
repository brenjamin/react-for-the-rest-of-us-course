      ...
      try {
        ...
        if (response.data) {
          ...
          if (appState.user.username !== response.data.author.username) {
            appDispatch({ type: "flashMessage", value: { message: "You do not have permission to edit that post.", type: "danger" } })
    ...
    if (state.sendCount) {
      ...
      async function editPost() {
        try {
          ...
          appDispatch({ type: "flashMessage", value: { message: "Post was updated!" } })
        } catch (e) {
          console.log("There was a problem")
        }
      }
